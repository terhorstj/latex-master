...
\usepackage{microtype,textcase,soul,siunitx}
\usepackage[version=4]{mhchem}
\usepackage[bottom,hang]{footmisc}\setlength\footnotemargin{9pt}\interfootnotelinepenalty=10000\setlength{\skip\footins}{0.5cm}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead[L]{\textit{Terhorst, J.}}
\fancyhead[R]{\thepage}
\fancyfoot[C]{}
...
\DeclareRobustCommand{\spacedallcaps}[1]{\textls[160]{\MakeTextUppercase{\sffamily #1}}}
...
\title{\vspace*{-0.5in}\spacedallcaps{\huge Article Title}}
\author{\spacedlowsmallcaps{John Terhorst*,$^\dagger$}}
\date{}
\end{comment}
...
%\begin{comment} % biber/biblatex - using custom.bbx/cbx files from acs
...
\begin{comment}
\begin{center}
\resizebox{\textwidth}{!}{\input{nucleus}} % to scale \input{} figure based on geometry
\captionof{figure}{Ions.}
\label{fig:ion}
\end{center}

\begin{center}
\scalebox{.75}{\input{nucleus}} % or to scale it based on figure dimensiona
\captionof{figure}{Ions.}
\label{fig:ions}
\end{center}
...
\begin{comment} % usage:
See \crefrange{eqa}{eqb}. Also see \cref{eqb}. Plus, \cref{eqa,eqb}
See \crefrange{tabgrav}{tabtwo}. Also see \cref{tabtwo}. Plus, \cref{tabgrav,tabtwo}
See \crefrange{bornrad}{no}. Also see \cref{no}. Plus, \cref{bornrad,no}
\end{comment}
